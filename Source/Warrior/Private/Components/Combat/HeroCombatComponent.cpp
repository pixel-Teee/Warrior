...
{
	//Debug::Print(GetOwningPawn()->GetActorNameOrLabel() + TEXT(" hit ") + HitActor->GetActorNameOrLabel(), FColor::Red);
	...
	Data.Instigator = GetOwningPawn(); //hero
	Data.Target = HitActor; //enemy
